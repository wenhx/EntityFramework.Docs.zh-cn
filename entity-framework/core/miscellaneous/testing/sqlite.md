...
>[!TIP]
> 若要使用`SqliteConnection()`并`.UseSqlite()`扩展方法，引用的 NuGet 包[Microsoft.EntityFrameworkCore.Sqlite](https://www.nuget.org/packages/Microsoft.EntityFrameworkCore.Sqlite/)。
