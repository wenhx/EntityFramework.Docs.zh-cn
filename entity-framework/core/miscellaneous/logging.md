...
* [Microsoft.Extensions.Logging.Console](https://www.nuget.org/packages/Microsoft.Extensions.Logging.Console/):一个简单的控制台记录器。
...
* [Microsoft.Extensions.Logging.TraceSource](https://www.nuget.org/packages/Microsoft.Extensions.Logging.TraceSource/):会向使用 System.Diagnostics.TraceSource.TraceEvent() 的跟踪侦听器。

> [!NOTE]
> 下面的代码示例使用`ConsoleLoggerProvider`已过时版本 2.2 中的构造函数。 适当替换已过时的日志记录 Api 将在版本 3.0 中提供。 在此期间，则可以安全地忽略，并禁止显示警告。
