...
## <a name="alias-element-msl"></a><span data-ttu-id="ad5fb-119">Alias 元素 (MSL)</span><span class="sxs-lookup"><span data-stu-id="ad5fb-119">Alias Element (MSL)</span></span>
...
<span data-ttu-id="ad5fb-162">请考虑使用以下概念模型实体类型：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-162">Consider the following conceptual model entity type:</span></span>
...
<span data-ttu-id="ad5fb-242">另请考虑使用以下概念模型复杂类型：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-242">Also consider the following conceptual model complex type:</span></span>
...
## <a name="entitycontainermapping-element-msl"></a><span data-ttu-id="ad5fb-355">EntityContainerMapping 元素 (MSL)</span><span class="sxs-lookup"><span data-stu-id="ad5fb-355">EntityContainerMapping Element (MSL)</span></span>
...
### <a name="applicable-attributes"></a><span data-ttu-id="ad5fb-391">适用的属性</span><span class="sxs-lookup"><span data-stu-id="ad5fb-391">Applicable Attributes</span></span>
...
### <a name="example"></a><span data-ttu-id="ad5fb-439">示例</span><span class="sxs-lookup"><span data-stu-id="ad5fb-439">Example</span></span>

<span data-ttu-id="ad5fb-440">下一示例演示其中根类型为抽象类型的类型层次结构的映射。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-440">The next example shows the mapping of a type hierarchy in which the root type is abstract.</span></span> <span data-ttu-id="ad5fb-441">请注意， `IsOfType` **TypeName** 特性的语法的用法。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-441">Note the use of the `IsOfType` syntax for the **TypeName** attributes.</span></span>
...
## <a name="functionimportmapping-element-msl"></a><span data-ttu-id="ad5fb-442">FunctionImportMapping 元素 (MSL)</span><span class="sxs-lookup"><span data-stu-id="ad5fb-442">FunctionImportMapping Element (MSL)</span></span>

<span data-ttu-id="ad5fb-443">映射规范语言 (MSL) 中的 **FunctionImportMapping** 元素定义概念模型中的函数导入与基础数据库中的存储过程或函数之间的映射。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-443">The **FunctionImportMapping** element in mapping specification language (MSL) defines the mapping between a function import in the conceptual model and a stored procedure or function in the underlying database.</span></span> <span data-ttu-id="ad5fb-444">函数导入必须在概念模型中进行声明，存储的过程必须在存储模型中进行声明。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-444">Function imports must be declared in the conceptual model and stored procedures must be declared in the storage model.</span></span> <span data-ttu-id="ad5fb-445">有关详细信息，请参阅 FunctionImport 元素 (CSDL) 和 Function 元素 (SSDL) 。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-445">For more information, see FunctionImport Element (CSDL) and Function Element (SSDL).</span></span>

> [!NOTE]
> <span data-ttu-id="ad5fb-446">默认情况下，如果函数导入返回概念模型实体类型或复杂类型，则基础存储过程返回的列名称必须与概念模型类型中的属性名称完全匹配。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-446">By default, if a function import returns a conceptual model entity type or complex type, then the names of the columns returned by the underlying stored procedure must exactly match the names of the properties on the conceptual model type.</span></span> <span data-ttu-id="ad5fb-447">如果列名称与属性名称不完全匹配，则必须在 ResultMapping 元素中定义映射。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-447">If the column names do not exactly match the property names, the mapping must be defined in a ResultMapping element.</span></span>

<span data-ttu-id="ad5fb-448">**FunctionImportMapping**元素可以具有以下子元素：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-448">The **FunctionImportMapping** element can have the following child elements:</span></span>

-   <span data-ttu-id="ad5fb-449">ResultMapping (零个或多个) </span><span class="sxs-lookup"><span data-stu-id="ad5fb-449">ResultMapping (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="ad5fb-450">适用的属性</span><span class="sxs-lookup"><span data-stu-id="ad5fb-450">Applicable Attributes</span></span>

<span data-ttu-id="ad5fb-451">下表描述了适用于 **FunctionImportMapping** 元素的属性：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-451">The following table describes the attributes that are applicable to the **FunctionImportMapping** element:</span></span>

| <span data-ttu-id="ad5fb-452">属性名称</span><span class="sxs-lookup"><span data-stu-id="ad5fb-452">Attribute Name</span></span>         | <span data-ttu-id="ad5fb-453">是否必需</span><span class="sxs-lookup"><span data-stu-id="ad5fb-453">Is Required</span></span> | <span data-ttu-id="ad5fb-454">值</span><span class="sxs-lookup"><span data-stu-id="ad5fb-454">Value</span></span>                                                                                   |
|:-----------------------|:------------|:----------------------------------------------------------------------------------------|
| <span data-ttu-id="ad5fb-455">**FunctionImportName**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-455">**FunctionImportName**</span></span> | <span data-ttu-id="ad5fb-456">是</span><span class="sxs-lookup"><span data-stu-id="ad5fb-456">Yes</span></span>         | <span data-ttu-id="ad5fb-457">概念模型中要映射的函数导入的名称。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-457">The name of the function import in the conceptual model that is being mapped.</span></span>           |
| <span data-ttu-id="ad5fb-458">**FunctionName**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-458">**FunctionName**</span></span>       | <span data-ttu-id="ad5fb-459">是</span><span class="sxs-lookup"><span data-stu-id="ad5fb-459">Yes</span></span>         | <span data-ttu-id="ad5fb-460">存储模型中要映射的函数的命名空间限定名称。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-460">The namespace-qualified name of the function in the storage model that is being mapped.</span></span> |

### <a name="example"></a><span data-ttu-id="ad5fb-461">示例</span><span class="sxs-lookup"><span data-stu-id="ad5fb-461">Example</span></span>

<span data-ttu-id="ad5fb-462">下面的示例基于 School 模型。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-462">The following example is based on the School model.</span></span> <span data-ttu-id="ad5fb-463">请考虑在存储模型中使用以下函数：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-463">Consider the following function in the storage model:</span></span>
...
<span data-ttu-id="ad5fb-464">另请考虑在概念模型中使用此函数导入：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-464">Also consider this function import in the conceptual model:</span></span>
...
<span data-ttu-id="ad5fb-465">下面的示例显示一个 **FunctionImportMapping** 元素，该元素用于将上述函数和函数导入映射到彼此：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-465">The following example show a **FunctionImportMapping** element used to map the function and function import above to each other:</span></span>
...
```
 
## <a name="insertfunction-element-msl"></a><span data-ttu-id="ad5fb-466">InsertFunction 元素 (MSL)</span><span class="sxs-lookup"><span data-stu-id="ad5fb-466">InsertFunction Element (MSL)</span></span>

<span data-ttu-id="ad5fb-467">映射规范语言 (MSL) 中的 **InsertFunction** 元素将概念模型中的实体类型或关联的插入函数映射到基础数据库中的存储过程。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-467">The **InsertFunction** element in mapping specification language (MSL) maps the insert function of an entity type or association in the conceptual model to a stored procedure in the underlying database.</span></span> <span data-ttu-id="ad5fb-468">将修改函数映射到其中的存储过程必须在存储模型中声明。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-468">Stored procedures to which modification functions are mapped must be declared in the storage model.</span></span> <span data-ttu-id="ad5fb-469">有关详细信息，请参阅 Function 元素 (SSDL) 。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-469">For more information, see Function Element (SSDL).</span></span>

> [!NOTE]
> <span data-ttu-id="ad5fb-470">如果没有将实体类型的所有三个插入、更新或删除操作映射到存储过程，则在运行时执行并引发 UpdateException 时，未映射的操作将失败。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-470">If you do not map all three of the insert, update, or delete operations of a entity type to stored procedures, the unmapped operations will fail if executed at runtime and an UpdateException is thrown.</span></span>

<span data-ttu-id="ad5fb-471">**InsertFunction**元素可以是 ModificationFunctionMapping 元素的子元素，并应用于 EntityTypeMapping 元素或 AssociationSetMapping 元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-471">The **InsertFunction** element can be a child of the ModificationFunctionMapping element and applied to the EntityTypeMapping element or the AssociationSetMapping element.</span></span>

### <a name="insertfunction-applied-to-entitytypemapping"></a><span data-ttu-id="ad5fb-472">应用于 EntityTypeMapping 的 InsertFunction</span><span class="sxs-lookup"><span data-stu-id="ad5fb-472">InsertFunction Applied to EntityTypeMapping</span></span>

<span data-ttu-id="ad5fb-473">当应用于 EntityTypeMapping 元素时， **InsertFunction** 元素会将概念模型中的实体类型的插入函数映射到存储过程。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-473">When applied to the EntityTypeMapping element, the **InsertFunction** element maps the insert function of an entity type in the conceptual model to a stored procedure.</span></span>

<span data-ttu-id="ad5fb-474">**InsertFunction**元素在应用于**EntityTypeMapping**元素时可以具有以下子元素：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-474">The **InsertFunction** element can have the following child elements when applied to an **EntityTypeMapping** element:</span></span>

-   <span data-ttu-id="ad5fb-475">AssociationEnd（零个或多个）</span><span class="sxs-lookup"><span data-stu-id="ad5fb-475">AssociationEnd (zero or more)</span></span>
-   <span data-ttu-id="ad5fb-476">ComplexProperty（零个或多个）</span><span class="sxs-lookup"><span data-stu-id="ad5fb-476">ComplexProperty (zero or more)</span></span>
-   <span data-ttu-id="ad5fb-477">ResultBinding（零个或一个）</span><span class="sxs-lookup"><span data-stu-id="ad5fb-477">ResultBinding (zero or one)</span></span>
-   <span data-ttu-id="ad5fb-478">ScarlarProperty（零个或多个）</span><span class="sxs-lookup"><span data-stu-id="ad5fb-478">ScarlarProperty (zero or more)</span></span>

#### <a name="applicable-attributes"></a><span data-ttu-id="ad5fb-479">适用的属性</span><span class="sxs-lookup"><span data-stu-id="ad5fb-479">Applicable Attributes</span></span>

<span data-ttu-id="ad5fb-480">下表描述了应用于**EntityTypeMapping**元素时可应用于**InsertFunction**元素的特性。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-480">The following table describes the attributes that can be applied to the **InsertFunction** element when applied to an **EntityTypeMapping** element.</span></span>

| <span data-ttu-id="ad5fb-481">属性名称</span><span class="sxs-lookup"><span data-stu-id="ad5fb-481">Attribute Name</span></span>            | <span data-ttu-id="ad5fb-482">是否必需</span><span class="sxs-lookup"><span data-stu-id="ad5fb-482">Is Required</span></span> | <span data-ttu-id="ad5fb-483">值</span><span class="sxs-lookup"><span data-stu-id="ad5fb-483">Value</span></span>                                                                                                                                                    |
|:--------------------------|:------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="ad5fb-484">**FunctionName**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-484">**FunctionName**</span></span>          | <span data-ttu-id="ad5fb-485">是</span><span class="sxs-lookup"><span data-stu-id="ad5fb-485">Yes</span></span>         | <span data-ttu-id="ad5fb-486">插入函数要映射到的存储过程的命名空间限定名称。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-486">The namespace-qualified name of the stored procedure to which the insert function is mapped.</span></span> <span data-ttu-id="ad5fb-487">存储过程必须在存储模型中声明。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-487">The stored procedure must be declared in the storage model.</span></span> |
| <span data-ttu-id="ad5fb-488">**RowsAffectedParameter**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-488">**RowsAffectedParameter**</span></span> | <span data-ttu-id="ad5fb-489">否</span><span class="sxs-lookup"><span data-stu-id="ad5fb-489">No</span></span>          | <span data-ttu-id="ad5fb-490">返回受影响行数的输出参数的名称。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-490">The name of the output parameter that returns the number of affected rows.</span></span>                                                                               |

#### <a name="example"></a><span data-ttu-id="ad5fb-491">示例</span><span class="sxs-lookup"><span data-stu-id="ad5fb-491">Example</span></span>

<span data-ttu-id="ad5fb-492">下面的示例基于 School 模型，并显示了用于将 Person 实体类型的插入函数映射到**InsertPerson**存储过程的**InsertFunction**元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-492">The following example is based on the School model and shows the **InsertFunction** element used to map insert function of the Person entity type to the **InsertPerson** stored procedure.</span></span> <span data-ttu-id="ad5fb-493">**InsertPerson**存储过程在存储模型中声明。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-493">The **InsertPerson** stored procedure is declared in the storage model.</span></span>
...
```
### <a name="insertfunction-applied-to-associationsetmapping"></a><span data-ttu-id="ad5fb-494">应用于 AssociationSetMapping 的 InsertFunction</span><span class="sxs-lookup"><span data-stu-id="ad5fb-494">InsertFunction Applied to AssociationSetMapping</span></span>

<span data-ttu-id="ad5fb-495">当应用于 AssociationSetMapping 元素时， **InsertFunction** 元素会将概念模型中的关联的插入函数映射到存储过程。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-495">When applied to the AssociationSetMapping element, the **InsertFunction** element maps the insert function of an association in the conceptual model to a stored procedure.</span></span>

<span data-ttu-id="ad5fb-496">**InsertFunction**元素在应用于**AssociationSetMapping**元素时可以具有以下子元素：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-496">The **InsertFunction** element can have the following child elements when applied to the **AssociationSetMapping** element:</span></span>

-   <span data-ttu-id="ad5fb-497">EndProperty</span><span class="sxs-lookup"><span data-stu-id="ad5fb-497">EndProperty</span></span>

#### <a name="applicable-attributes"></a><span data-ttu-id="ad5fb-498">适用的属性</span><span class="sxs-lookup"><span data-stu-id="ad5fb-498">Applicable Attributes</span></span>

<span data-ttu-id="ad5fb-499">下表描述了可应用于**AssociationSetMapping**元素的**InsertFunction**元素的特性。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-499">The following table describes the attributes that can be applied to the **InsertFunction** element when it is applied to the **AssociationSetMapping** element.</span></span>

| <span data-ttu-id="ad5fb-500">属性名称</span><span class="sxs-lookup"><span data-stu-id="ad5fb-500">Attribute Name</span></span>            | <span data-ttu-id="ad5fb-501">是否必需</span><span class="sxs-lookup"><span data-stu-id="ad5fb-501">Is Required</span></span> | <span data-ttu-id="ad5fb-502">值</span><span class="sxs-lookup"><span data-stu-id="ad5fb-502">Value</span></span>                                                                                                                                                    |
|:--------------------------|:------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="ad5fb-503">**FunctionName**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-503">**FunctionName**</span></span>          | <span data-ttu-id="ad5fb-504">是</span><span class="sxs-lookup"><span data-stu-id="ad5fb-504">Yes</span></span>         | <span data-ttu-id="ad5fb-505">插入函数要映射到的存储过程的命名空间限定名称。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-505">The namespace-qualified name of the stored procedure to which the insert function is mapped.</span></span> <span data-ttu-id="ad5fb-506">存储过程必须在存储模型中声明。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-506">The stored procedure must be declared in the storage model.</span></span> |
| <span data-ttu-id="ad5fb-507">**RowsAffectedParameter**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-507">**RowsAffectedParameter**</span></span> | <span data-ttu-id="ad5fb-508">否</span><span class="sxs-lookup"><span data-stu-id="ad5fb-508">No</span></span>          | <span data-ttu-id="ad5fb-509">返回受影响行数的输出参数的名称。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-509">The name of the output parameter that returns the number of rows affected.</span></span>                                                                               |

#### <a name="example"></a><span data-ttu-id="ad5fb-510">示例</span><span class="sxs-lookup"><span data-stu-id="ad5fb-510">Example</span></span>

<span data-ttu-id="ad5fb-511">下面的示例基于 School 模型，并显示了用于将**courseinstructor.courseid**关联的插入函数映射到**InsertCourseInstructor**存储过程的**InsertFunction**元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-511">The following example is based on the School model and shows the **InsertFunction** element used to map insert function of the **CourseInstructor** association to the **InsertCourseInstructor** stored procedure.</span></span> <span data-ttu-id="ad5fb-512">**InsertCourseInstructor**存储过程在存储模型中声明。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-512">The **InsertCourseInstructor** stored procedure is declared in the storage model.</span></span>
...
## <a name="mapping-element-msl"></a><span data-ttu-id="ad5fb-513">Mapping 元素 (MSL)</span><span class="sxs-lookup"><span data-stu-id="ad5fb-513">Mapping Element (MSL)</span></span>

<span data-ttu-id="ad5fb-514">映射规范语言 (MSL) 中的 **mapping** 元素包含用于将概念模型中定义的对象映射到数据库 (的信息，如存储模型) 中所述。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-514">The **Mapping** element in mapping specification language (MSL) contains information for mapping objects that are defined in a conceptual model to a database (as described in a storage model).</span></span> <span data-ttu-id="ad5fb-515">有关详细信息，请参阅 CSDL 规范和 SSDL 规范。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-515">For more information, see CSDL Specification and SSDL Specification.</span></span>

<span data-ttu-id="ad5fb-516">**Mapping**元素是映射规范的根元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-516">The **Mapping** element is the root element for a mapping specification.</span></span> <span data-ttu-id="ad5fb-517">映射规范的 XML 命名空间为 https://schemas.microsoft.com/ado/2009/11/mapping/cs 。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-517">The XML namespace for mapping specifications is https://schemas.microsoft.com/ado/2009/11/mapping/cs.</span></span>

<span data-ttu-id="ad5fb-518">映射元素可以具有以下子元素（按所列顺序）：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-518">The mapping element can have the following child elements (in the order listed):</span></span>

-   <span data-ttu-id="ad5fb-519">Alias（零个或多个）</span><span class="sxs-lookup"><span data-stu-id="ad5fb-519">Alias (zero or more)</span></span>
-   <span data-ttu-id="ad5fb-520">EntityContainerMapping（恰好一个）</span><span class="sxs-lookup"><span data-stu-id="ad5fb-520">EntityContainerMapping (exactly one)</span></span>

<span data-ttu-id="ad5fb-521">MSL 中引用的概念模型类型和存储模型类型的名称必须由其相应的命名空间名称限定。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-521">Names of conceptual and storage model types that are referenced in MSL must be qualified by their respective namespace names.</span></span> <span data-ttu-id="ad5fb-522">有关概念模型命名空间名称的信息，请参阅 (CSDL) 的架构元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-522">For information about the conceptual model namespace name, see Schema Element (CSDL).</span></span> <span data-ttu-id="ad5fb-523">有关存储模型命名空间名称的信息，请参阅 (SSDL) 的架构元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-523">For information about the storage model namespace name, see Schema Element (SSDL).</span></span> <span data-ttu-id="ad5fb-524">可以使用 Alias 元素定义 MSL 中使用的命名空间的别名。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-524">Aliases for namespaces that are used in MSL can be defined with the Alias element.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="ad5fb-525">适用的属性</span><span class="sxs-lookup"><span data-stu-id="ad5fb-525">Applicable Attributes</span></span>

<span data-ttu-id="ad5fb-526">下表描述了可应用到 **Mapping** 元素的特性。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-526">The table below describes the attributes that can be applied to the **Mapping** element.</span></span>

| <span data-ttu-id="ad5fb-527">属性名称</span><span class="sxs-lookup"><span data-stu-id="ad5fb-527">Attribute Name</span></span> | <span data-ttu-id="ad5fb-528">是否必需</span><span class="sxs-lookup"><span data-stu-id="ad5fb-528">Is Required</span></span> | <span data-ttu-id="ad5fb-529">值</span><span class="sxs-lookup"><span data-stu-id="ad5fb-529">Value</span></span>                                                 |
|:---------------|:------------|:------------------------------------------------------|
| <span data-ttu-id="ad5fb-530">**空间**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-530">**Space**</span></span>      | <span data-ttu-id="ad5fb-531">是</span><span class="sxs-lookup"><span data-stu-id="ad5fb-531">Yes</span></span>         | <span data-ttu-id="ad5fb-532">**C-S**。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-532">**C-S**.</span></span> <span data-ttu-id="ad5fb-533">这是固定值，因此不能更改。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-533">This is a fixed value and cannot be changed.</span></span> |

### <a name="example"></a><span data-ttu-id="ad5fb-534">示例</span><span class="sxs-lookup"><span data-stu-id="ad5fb-534">Example</span></span>

<span data-ttu-id="ad5fb-535">下面的示例演示一个基于 School 模型的一部分的 **映射** 元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-535">The following example shows a **Mapping** element that is based on part of the School model.</span></span> <span data-ttu-id="ad5fb-536">有关 School 模型的详细信息，请参阅 "快速入门" (实体框架) ：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-536">For more information about the School model, see Quickstart (Entity Framework):</span></span>
...
## <a name="mappingfragment-element-msl"></a><span data-ttu-id="ad5fb-537">MappingFragment 元素 (MSL)</span><span class="sxs-lookup"><span data-stu-id="ad5fb-537">MappingFragment Element (MSL)</span></span>

<span data-ttu-id="ad5fb-538">映射规范语言 (MSL) 中的 **MappingFragment** 元素定义概念模型实体类型的属性与数据库中的表或视图之间的映射。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-538">The **MappingFragment** element in mapping specification language (MSL) defines the mapping between the properties of a conceptual model entity type and a table or view in the database.</span></span> <span data-ttu-id="ad5fb-539">有关概念模型实体类型与基础数据库表或视图的信息，请参见 EntityType 元素 (CSDL) 和 EntitySet 元素 (SSDL)。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-539">For information about conceptual model entity types and underlying database tables or views, see EntityType Element (CSDL) and EntitySet Element (SSDL).</span></span> <span data-ttu-id="ad5fb-540">**MappingFragment**可以是 EntityTypeMapping 元素或 EntitySetMapping 元素的子元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-540">The **MappingFragment** can be a child element of the EntityTypeMapping element or the EntitySetMapping element.</span></span>

<span data-ttu-id="ad5fb-541">**MappingFragment**元素可以具有以下子元素：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-541">The **MappingFragment** element can have the following child elements:</span></span>

-   <span data-ttu-id="ad5fb-542">ComplexType（零个或多个）</span><span class="sxs-lookup"><span data-stu-id="ad5fb-542">ComplexType (zero or more)</span></span>
-   <span data-ttu-id="ad5fb-543">ScalarProperty（零个或多个）</span><span class="sxs-lookup"><span data-stu-id="ad5fb-543">ScalarProperty (zero or more)</span></span>
-   <span data-ttu-id="ad5fb-544">Condition（零个或多个）</span><span class="sxs-lookup"><span data-stu-id="ad5fb-544">Condition (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="ad5fb-545">适用的属性</span><span class="sxs-lookup"><span data-stu-id="ad5fb-545">Applicable Attributes</span></span>

<span data-ttu-id="ad5fb-546">下表介绍可应用于 **MappingFragment** 元素的特性。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-546">The following table describes the attributes that can be applied to the **MappingFragment** element.</span></span>

| <span data-ttu-id="ad5fb-547">属性名称</span><span class="sxs-lookup"><span data-stu-id="ad5fb-547">Attribute Name</span></span>          | <span data-ttu-id="ad5fb-548">是否必需</span><span class="sxs-lookup"><span data-stu-id="ad5fb-548">Is Required</span></span> | <span data-ttu-id="ad5fb-549">值</span><span class="sxs-lookup"><span data-stu-id="ad5fb-549">Value</span></span>                                                                                                                                                                                                                         |
|:------------------------|:------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="ad5fb-550">**StoreEntitySet**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-550">**StoreEntitySet**</span></span>      | <span data-ttu-id="ad5fb-551">是</span><span class="sxs-lookup"><span data-stu-id="ad5fb-551">Yes</span></span>         | <span data-ttu-id="ad5fb-552">要映射的表或视图的名称。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-552">The name of the table or view that is being mapped.</span></span>                                                                                                                                                                           |
| <span data-ttu-id="ad5fb-553">**MakeColumnsDistinct**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-553">**MakeColumnsDistinct**</span></span> | <span data-ttu-id="ad5fb-554">否</span><span class="sxs-lookup"><span data-stu-id="ad5fb-554">No</span></span>          | <span data-ttu-id="ad5fb-555">**True** 或 **False** ，具体取决于是否只返回不同的行。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-555">**True** or **False** depending on whether only distinct rows are returned.</span></span> <br/> <span data-ttu-id="ad5fb-556">如果此特性设置为 **True**，则 EntityContainerMapping 元素的 **GenerateUpdateViews** 特性必须设置为 **False**。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-556">If this attribute is set to **True**, the **GenerateUpdateViews** attribute of the EntityContainerMapping element must be set to **False**.</span></span> |

### <a name="example"></a><span data-ttu-id="ad5fb-557">示例</span><span class="sxs-lookup"><span data-stu-id="ad5fb-557">Example</span></span>

<span data-ttu-id="ad5fb-558">下面的示例演示一个 **MappingFragment** 元素作为 **EntityTypeMapping** 元素的子元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-558">The following example shows a **MappingFragment** element as the child of an **EntityTypeMapping** element.</span></span> <span data-ttu-id="ad5fb-559">在此示例中，概念模型中的 **课程** 类型的属性将映射到数据库中 **课程** 表的列。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-559">In this example, properties of the **Course** type in the conceptual model are mapped to columns of the **Course** table in the database.</span></span>
...
### <a name="example"></a><span data-ttu-id="ad5fb-560">示例</span><span class="sxs-lookup"><span data-stu-id="ad5fb-560">Example</span></span>

<span data-ttu-id="ad5fb-561">下面的示例演示一个 **MappingFragment** 元素作为 **EntitySetMapping** 元素的子元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-561">The following example shows a **MappingFragment** element as the child of an **EntitySetMapping** element.</span></span> <span data-ttu-id="ad5fb-562">如上面的示例所示，概念模型中的 **课程** 类型的属性将映射到数据库中 **课程** 表的列。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-562">As in the example above, properties of the **Course** type in the conceptual model are mapped to columns of the **Course** table in the database.</span></span>
...
## <a name="modificationfunctionmapping-element-msl"></a><span data-ttu-id="ad5fb-563">ModificationFunctionMapping 元素 (MSL)</span><span class="sxs-lookup"><span data-stu-id="ad5fb-563">ModificationFunctionMapping Element (MSL)</span></span>

<span data-ttu-id="ad5fb-564">映射规范语言 (MSL) 中的 **ModificationFunctionMapping** 元素将概念模型实体类型的插入、更新和删除函数映射到基础数据库中的存储过程。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-564">The **ModificationFunctionMapping** element in mapping specification language (MSL) maps the insert, update, and delete functions of a conceptual model entity type to stored procedures in the underlying database.</span></span> <span data-ttu-id="ad5fb-565">**ModificationFunctionMapping**元素还可以将概念模型中的多对多关联的插入和删除函数映射到基础数据库中的存储过程。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-565">The **ModificationFunctionMapping** element can also map the insert and delete functions for many-to-many associations in the conceptual model to stored procedures in the underlying database.</span></span> <span data-ttu-id="ad5fb-566">将修改函数映射到其中的存储过程必须在存储模型中声明。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-566">Stored procedures to which modification functions are mapped must be declared in the storage model.</span></span> <span data-ttu-id="ad5fb-567">有关详细信息，请参阅 Function 元素 (SSDL) 。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-567">For more information, see Function Element (SSDL).</span></span>

> [!NOTE]
> <span data-ttu-id="ad5fb-568">如果没有将实体类型的所有三个插入、更新或删除操作映射到存储过程，则在运行时执行并引发 UpdateException 时，未映射的操作将失败。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-568">If you do not map all three of the insert, update, or delete operations of a entity type to stored procedures, the unmapped operations will fail if executed at runtime and an UpdateException is thrown.</span></span>


> [!NOTE]
> <span data-ttu-id="ad5fb-569">如果将继承层次结构中的一个实体的修改函数映射到存储过程，则必须将该层次结构中所有类型的修改函数都映射到存储过程。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-569">If the modification functions for one entity in an inheritance hierarchy are mapped to stored procedures, then modification functions for all types in the hierarchy must be mapped to stored procedures.</span></span>

<span data-ttu-id="ad5fb-570">**ModificationFunctionMapping**元素可以是 EntityTypeMapping 元素或 AssociationSetMapping 元素的子元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-570">The **ModificationFunctionMapping** element can be a child of the EntityTypeMapping element or the AssociationSetMapping element.</span></span>

<span data-ttu-id="ad5fb-571">**ModificationFunctionMapping**元素可以具有以下子元素：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-571">The **ModificationFunctionMapping** element can have the following child elements:</span></span>

-   <span data-ttu-id="ad5fb-572">DeleteFunction（零个或一个）</span><span class="sxs-lookup"><span data-stu-id="ad5fb-572">DeleteFunction (zero or one)</span></span>
-   <span data-ttu-id="ad5fb-573">InsertFunction（零个或一个）</span><span class="sxs-lookup"><span data-stu-id="ad5fb-573">InsertFunction (zero or one)</span></span>
-   <span data-ttu-id="ad5fb-574">UpdateFunction（零个或一个）</span><span class="sxs-lookup"><span data-stu-id="ad5fb-574">UpdateFunction (zero or one)</span></span>

<span data-ttu-id="ad5fb-575">没有适用于 **ModificationFunctionMapping** 元素的特性。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-575">No attributes are applicable to the **ModificationFunctionMapping** element.</span></span>

### <a name="example"></a><span data-ttu-id="ad5fb-576">示例</span><span class="sxs-lookup"><span data-stu-id="ad5fb-576">Example</span></span>

<span data-ttu-id="ad5fb-577">下面的示例演示了 School 模型中 " **人员** " 实体集的实体集映射。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-577">The following example shows the entity set mapping for the **People** entity set in the School model.</span></span> <span data-ttu-id="ad5fb-578">除了 **person** 实体类型的列映射外，还会显示 " **人员** " 类型的插入、更新和删除函数的映射。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-578">In addition to the column mapping for the **Person** entity type, the mapping of the insert, update, and delete functions of the **Person** type are shown.</span></span> <span data-ttu-id="ad5fb-579">映射到的函数在存储模型中声明。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-579">The functions that are mapped to are declared in the storage model.</span></span>
...
### <a name="example"></a><span data-ttu-id="ad5fb-580">示例</span><span class="sxs-lookup"><span data-stu-id="ad5fb-580">Example</span></span>

<span data-ttu-id="ad5fb-581">下面的示例演示了 School 模型中 **courseinstructor.courseid** 关联集的关联集映射。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-581">The following example shows the association set mapping for the **CourseInstructor** association set in the School model.</span></span> <span data-ttu-id="ad5fb-582">除了 **courseinstructor.courseid** 关联的列映射外，还会显示 **courseinstructor.courseid** 关联的插入和删除函数的映射。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-582">In addition to the column mapping for the **CourseInstructor** association, the mapping of the insert and delete functions of the **CourseInstructor** association are shown.</span></span> <span data-ttu-id="ad5fb-583">映射到的函数在存储模型中声明。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-583">The functions that are mapped to are declared in the storage model.</span></span>
...
## <a name="queryview-element-msl"></a><span data-ttu-id="ad5fb-584">QueryView 元素 (MSL)</span><span class="sxs-lookup"><span data-stu-id="ad5fb-584">QueryView Element (MSL)</span></span>

<span data-ttu-id="ad5fb-585">映射规范语言 (MSL) 中的 **QueryView** 元素定义概念模型中的实体类型或关联与基础数据库中的表之间的只读映射。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-585">The **QueryView** element in mapping specification language (MSL) defines a read-only mapping between an entity type or association in the conceptual model and a table in the underlying database.</span></span> <span data-ttu-id="ad5fb-586">映射是使用针对存储模型计算的实体 SQL 查询定义的，你可以根据概念模型中的实体或关联来表示结果集。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-586">The mapping is defined with an Entity SQL query that is evaluated against the storage model, and you express the result set in terms of an entity or association in the conceptual model.</span></span> <span data-ttu-id="ad5fb-587">因为查询视图是只读的，所以不能使用标准更新命令来更新查询视图所定义的类型。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-587">Because query views are read-only, you cannot use standard update commands to update types that are defined by query views.</span></span> <span data-ttu-id="ad5fb-588">可以使用修改函数来更新这些类型。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-588">You can make updates to these types by using modification functions.</span></span> <span data-ttu-id="ad5fb-589">有关详细信息，请参阅如何：将修改函数映射到存储过程。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-589">For more information, see How to: Map Modification Functions to Stored Procedures.</span></span>

> [!NOTE]
> <span data-ttu-id="ad5fb-590">在 **QueryView** 元素中，不支持实体 SQL 包含 **GroupBy**、组聚合或导航属性的表达式。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-590">In the **QueryView** element, Entity SQL expressions that contain **GroupBy**, group aggregates, or navigation properties are not supported.</span></span>

 

<span data-ttu-id="ad5fb-591">**QueryView**元素可以是 EntitySetMapping 元素或 AssociationSetMapping 元素的子元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-591">The **QueryView** element can be a child of the EntitySetMapping element or the AssociationSetMapping element.</span></span> <span data-ttu-id="ad5fb-592">在前一种情况中，查询视图定义概念模型中实体的只读映射。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-592">In the former case, the query view defines a read-only mapping for an entity in the conceptual model.</span></span> <span data-ttu-id="ad5fb-593">在后一种情况中，查询视图定义概念模型中关联的只读映射。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-593">In the latter case, the query view defines a read-only mapping for an association in the conceptual model.</span></span>

> [!NOTE]
> <span data-ttu-id="ad5fb-594">如果 **AssociationSetMapping** 元素用于与引用约束的关联，则忽略 **AssociationSetMapping** 元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-594">If the **AssociationSetMapping** element is for an association with a referential constraint, the **AssociationSetMapping** element is ignored.</span></span> <span data-ttu-id="ad5fb-595">有关详细信息，请参阅 ReferentialConstraint 元素 (CSDL) 。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-595">For more information, see ReferentialConstraint Element (CSDL).</span></span>

<span data-ttu-id="ad5fb-596">**QueryView**元素不能具有任何子元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-596">The **QueryView** element cannot have any child elements.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="ad5fb-597">适用的属性</span><span class="sxs-lookup"><span data-stu-id="ad5fb-597">Applicable Attributes</span></span>

<span data-ttu-id="ad5fb-598">下表介绍可应用于 **QueryView** 元素的特性。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-598">The following table describes the attributes that can be applied to the **QueryView** element.</span></span>

| <span data-ttu-id="ad5fb-599">属性名称</span><span class="sxs-lookup"><span data-stu-id="ad5fb-599">Attribute Name</span></span> | <span data-ttu-id="ad5fb-600">是否必需</span><span class="sxs-lookup"><span data-stu-id="ad5fb-600">Is Required</span></span> | <span data-ttu-id="ad5fb-601">值</span><span class="sxs-lookup"><span data-stu-id="ad5fb-601">Value</span></span>                                                                         |
|:---------------|:------------|:------------------------------------------------------------------------------|
| <span data-ttu-id="ad5fb-602">**TypeName**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-602">**TypeName**</span></span>   | <span data-ttu-id="ad5fb-603">否</span><span class="sxs-lookup"><span data-stu-id="ad5fb-603">No</span></span>          | <span data-ttu-id="ad5fb-604">要由查询视图映射的概念模型类型的名称。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-604">The name of the conceptual model type that is being mapped by the query view.</span></span> |

### <a name="example"></a><span data-ttu-id="ad5fb-605">示例</span><span class="sxs-lookup"><span data-stu-id="ad5fb-605">Example</span></span>

<span data-ttu-id="ad5fb-606">下面的示例将 **QueryView** 元素显示为 **EntitySetMapping** 元素的子元素，并为 School 模型中的 **部门** 实体类型定义查询视图映射。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-606">The following example shows the **QueryView** element as a child of the **EntitySetMapping** element and defines a query view mapping for the **Department** entity type in the School Model.</span></span>
...
<span data-ttu-id="ad5fb-607">由于该查询仅返回存储模型中 " **部门** " 类型的成员子集，因此，School 模型中的 **部门** 类型已根据以下映射进行了修改：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-607">Because the query only returns a subset of the members of the **Department** type in the storage model, the **Department** type in the School model has been modified based on this mapping as follows:</span></span>
...
### <a name="example"></a><span data-ttu-id="ad5fb-608">示例</span><span class="sxs-lookup"><span data-stu-id="ad5fb-608">Example</span></span>

<span data-ttu-id="ad5fb-609">下一个示例显示了 **QueryView** 元素作为 **AssociationSetMapping** 元素的子元素，并为 School 模型中的关联定义了一个只读映射 `FK_Course_Department` 。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-609">The next example shows the **QueryView** element as the child of an **AssociationSetMapping** element and defines a read-only mapping for the `FK_Course_Department` association in the School model.</span></span>
...
```
 
### <a name="comments"></a><span data-ttu-id="ad5fb-610">说明</span><span class="sxs-lookup"><span data-stu-id="ad5fb-610">Comments</span></span>

<span data-ttu-id="ad5fb-611">可以定义查询视图来实现以下方案：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-611">You can define query views to enable the following scenarios:</span></span>

-   <span data-ttu-id="ad5fb-612">在概念模型中定义一个实体，该实体不包含存储模型中的实体的所有属性。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-612">Define an entity in the conceptual model that doesn't include all the properties of the entity in the storage model.</span></span> <span data-ttu-id="ad5fb-613">这包括没有默认值并且不支持 **null** 值的属性。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-613">This includes properties that do not have default values and do not support **null** values.</span></span>
-   <span data-ttu-id="ad5fb-614">将存储模型中计算的列映射到概念模型中实体类型的属性。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-614">Map computed columns in the storage model to properties of entity types in the conceptual model.</span></span>
-   <span data-ttu-id="ad5fb-615">定义一个映射，其中用于对概念模型中的实体进行分区的条件不基于相等性。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-615">Define a mapping where conditions used to partition entities in the conceptual model are not based on equality.</span></span> <span data-ttu-id="ad5fb-616">使用 **Condition** 元素指定条件映射时，所提供的条件必须等于指定的值。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-616">When you specify a conditional mapping using the **Condition** element, the supplied condition must equal the specified value.</span></span> <span data-ttu-id="ad5fb-617">有关详细信息，请参阅 Condition 元素 (MSL) 。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-617">For more information, see Condition Element (MSL).</span></span>
-   <span data-ttu-id="ad5fb-618">将存储模型中的同一列映射到概念模型中的多个类型。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-618">Map the same column in the storage model to multiple types in the conceptual model.</span></span>
-   <span data-ttu-id="ad5fb-619">将多个类型映射到同一个表。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-619">Map multiple types to the same table.</span></span>
-   <span data-ttu-id="ad5fb-620">在概念模型中定义不基于关系架构中的外键的关联。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-620">Define associations in the conceptual model that are not based on foreign keys in the relational schema.</span></span>
-   <span data-ttu-id="ad5fb-621">使用自定义业务逻辑设置概念模型中的属性值。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-621">Use custom business logic to set the value of properties in the conceptual model.</span></span> <span data-ttu-id="ad5fb-622">例如，您可以将数据源中的字符串值 "T" 映射到概念模型中的 **true**值（布尔值）。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-622">For example, you could map the string value "T" in the data source to a value of **true**, a Boolean, in the conceptual model.</span></span>
-   <span data-ttu-id="ad5fb-623">为查询结果定义条件筛选器。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-623">Define conditional filters for query results.</span></span>
-   <span data-ttu-id="ad5fb-624">强制对概念模型中的数据施加比存储模型中更少的限制。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-624">Enforce fewer restrictions on data in the conceptual model than in the storage model.</span></span> <span data-ttu-id="ad5fb-625">例如，您可以将概念模型中的属性设置为可以为 null，即使它映射到的列不支持 **null**值。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-625">For example, you could make a property in the conceptual model nullable even if the column to which it is mapped does not support **null**values.</span></span>

<span data-ttu-id="ad5fb-626">为实体定义查询视图时需要考虑以下注意事项：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-626">The following considerations apply when you define query views for entities:</span></span>

-   <span data-ttu-id="ad5fb-627">查询视图是只读的。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-627">Query views are read-only.</span></span> <span data-ttu-id="ad5fb-628">只能使用修改函数来更新实体。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-628">You can only make updates to entities by using modification functions.</span></span>
-   <span data-ttu-id="ad5fb-629">通过查询视图定义实体类型时，必须也通过查询视图来定义所有相关实体。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-629">When you define an entity type by a query view, you must also define all related entities by query views.</span></span>
-   <span data-ttu-id="ad5fb-630">当您将多对多关联映射到存储模型中表示关系架构中的链接表的实体时，必须在此链接表的**AssociationSetMapping**元素中定义**QueryView**元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-630">When you map a many-to-many association to an entity in the storage model that represents a link table in the relational schema, you must define a **QueryView** element in the **AssociationSetMapping** element for this link table.</span></span>
-   <span data-ttu-id="ad5fb-631">必须为类型层次结构中的所有类型定义查询视图。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-631">Query views must be defined for all types in a type hierarchy.</span></span> <span data-ttu-id="ad5fb-632">可以使用下列方式来实现：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-632">You can do this in the following ways:</span></span>
-   -   <span data-ttu-id="ad5fb-633">使用单个 **QueryView** 元素指定单个实体 SQL 查询，该查询返回层次结构中所有实体类型的联合。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-633">With a single **QueryView** element that specifies a single Entity SQL query that returns a union of all of the entity types in the hierarchy.</span></span>
    -   <span data-ttu-id="ad5fb-634">使用单个 **QueryView** 元素，该元素指定单个实体 SQL 查询，该查询使用 CASE 运算符根据特定条件返回层次结构中的特定实体类型。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-634">With a single **QueryView** element that specifies a single Entity SQL query that uses the CASE operator to return a specific entity type in the hierarchy based on a specific condition.</span></span>
    -   <span data-ttu-id="ad5fb-635">对于层次结构中的特定类型，使用额外的 **QueryView** 元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-635">With an additional **QueryView** element for a specific type in the hierarchy.</span></span> <span data-ttu-id="ad5fb-636">在这种情况下，请使用**QueryView**元素的**TypeName**特性来指定每个视图的实体类型。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-636">In this case, use the **TypeName** attribute of the **QueryView** element to specify the entity type for each view.</span></span>
-   <span data-ttu-id="ad5fb-637">定义查询视图时，不能在**EntitySetMapping**元素上指定**StorageSetName**属性。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-637">When a query view is defined, you cannot specify the **StorageSetName** attribute on the **EntitySetMapping** element.</span></span>
-   <span data-ttu-id="ad5fb-638">定义查询视图时， **EntitySetMapping**元素不能同时包含 **属性** 映射。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-638">When a query view is defined, the **EntitySetMapping**element cannot also contain **Property** mappings.</span></span>

## <a name="resultbinding-element-msl"></a><span data-ttu-id="ad5fb-639">ResultBinding 元素 (MSL)</span><span class="sxs-lookup"><span data-stu-id="ad5fb-639">ResultBinding Element (MSL)</span></span>

<span data-ttu-id="ad5fb-640">映射规范语言 (MSL) 中的 **ResultBinding** 元素将存储过程返回的列值映射到概念模型中的实体属性，同时将实体类型修改函数映射到基础数据库中的存储过程。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-640">The **ResultBinding** element in mapping specification language (MSL) maps column values that are returned by stored procedures to entity properties in the conceptual model when entity type modification functions are mapped to stored procedures in the underlying database.</span></span> <span data-ttu-id="ad5fb-641">例如，当 insert 存储过程返回标识列的值时， **ResultBinding** 元素会将返回的值映射到概念模型中的实体类型属性。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-641">For example, when the value of an identity column is returned by an insert stored procedure, the **ResultBinding** element maps the returned value to an entity type property in the conceptual model.</span></span>

<span data-ttu-id="ad5fb-642">**ResultBinding**元素可以是 InsertFunction 元素或 UpdateFunction 元素的子元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-642">The **ResultBinding** element can be child of the InsertFunction element or the UpdateFunction element.</span></span>

<span data-ttu-id="ad5fb-643">**ResultBinding**元素不能具有任何子元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-643">The **ResultBinding** element cannot have any child elements.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="ad5fb-644">适用的属性</span><span class="sxs-lookup"><span data-stu-id="ad5fb-644">Applicable Attributes</span></span>

<span data-ttu-id="ad5fb-645">下表描述了适用于 **ResultBinding** 元素的属性：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-645">The following table describes the attributes that are applicable to the **ResultBinding** element:</span></span>

| <span data-ttu-id="ad5fb-646">属性名称</span><span class="sxs-lookup"><span data-stu-id="ad5fb-646">Attribute Name</span></span> | <span data-ttu-id="ad5fb-647">是否必需</span><span class="sxs-lookup"><span data-stu-id="ad5fb-647">Is Required</span></span> | <span data-ttu-id="ad5fb-648">值</span><span class="sxs-lookup"><span data-stu-id="ad5fb-648">Value</span></span>                                                                         |
|:---------------|:------------|:------------------------------------------------------------------------------|
| <span data-ttu-id="ad5fb-649">**名称**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-649">**Name**</span></span>       | <span data-ttu-id="ad5fb-650">是</span><span class="sxs-lookup"><span data-stu-id="ad5fb-650">Yes</span></span>         | <span data-ttu-id="ad5fb-651">概念模型中要映射的实体属性的名称。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-651">The name of the entity property in the conceptual model that is being mapped.</span></span> |
| <span data-ttu-id="ad5fb-652">**ColumnName**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-652">**ColumnName**</span></span> | <span data-ttu-id="ad5fb-653">是</span><span class="sxs-lookup"><span data-stu-id="ad5fb-653">Yes</span></span>         | <span data-ttu-id="ad5fb-654">要映射的列的名称。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-654">The name of the column being mapped.</span></span>                                          |

### <a name="example"></a><span data-ttu-id="ad5fb-655">示例</span><span class="sxs-lookup"><span data-stu-id="ad5fb-655">Example</span></span>

<span data-ttu-id="ad5fb-656">下面的示例基于 School 模型，并显示用于将**Person**实体类型的插入函数映射到**InsertPerson**存储过程的**InsertFunction**元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-656">The following example is based on the School model and shows an **InsertFunction** element used to map the insert function of the **Person** entity type to the **InsertPerson** stored procedure.</span></span> <span data-ttu-id="ad5fb-657"> (**InsertPerson** 存储过程如下所示，并在存储模型中声明。 ) **ResultBinding** 元素用于将存储过程 (**NewPersonID**) 返回的列值映射到 (**PersonID**) 的实体类型属性。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-657">(The **InsertPerson** stored procedure is shown below and is declared in the storage model.) A **ResultBinding** element is used to map a column value that is returned by the stored procedure (**NewPersonID**) to an entity type property (**PersonID**).</span></span>
...
<span data-ttu-id="ad5fb-658">以下 Transact-sql 介绍了 **InsertPerson** 存储过程：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-658">The following Transact-SQL describes the **InsertPerson** stored procedure:</span></span>
...
## <a name="resultmapping-element-msl"></a><span data-ttu-id="ad5fb-659">ResultMapping 元素 (MSL)</span><span class="sxs-lookup"><span data-stu-id="ad5fb-659">ResultMapping Element (MSL)</span></span>

<span data-ttu-id="ad5fb-660">映射规范语言 (MSL) 中的 **ResultMapping** 元素定义概念模型中的函数导入与基础数据库中的存储过程之间的映射（如果满足以下条件）：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-660">The **ResultMapping** element in mapping specification language (MSL) defines the mapping between a function import in the conceptual model and a stored procedure in the underlying database when the following are true:</span></span>

-   <span data-ttu-id="ad5fb-661">函数导入返回一个概念模型实体类型或复杂类型。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-661">The function import returns a conceptual model entity type or complex type.</span></span>
-   <span data-ttu-id="ad5fb-662">存储过程返回的列的名称与实体类型或复杂类型中的属性名称不完全匹配。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-662">The names of the columns returned by the stored procedure do not exactly match the names of the properties on the entity type or complex type.</span></span>

<span data-ttu-id="ad5fb-663">默认情况下，存储过程返回的列与实体类型或复杂类型中的属性之间的映射基于列名称和属性名称。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-663">By default, the mapping between the columns returned by a stored procedure and an entity type or complex type is based on column and property names.</span></span> <span data-ttu-id="ad5fb-664">如果列名称与属性名称不完全匹配，则必须使用 **ResultMapping** 元素来定义映射。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-664">If column names do not exactly match property names, you must use the **ResultMapping** element to define the mapping.</span></span> <span data-ttu-id="ad5fb-665">有关默认映射的示例，请参阅 FunctionImportMapping 元素 (MSL) 。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-665">For an example of the default mapping, see FunctionImportMapping Element (MSL).</span></span>

<span data-ttu-id="ad5fb-666">**ResultMapping**元素是 FunctionImportMapping 元素的子元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-666">The **ResultMapping** element is a child element of the FunctionImportMapping element.</span></span>

<span data-ttu-id="ad5fb-667">**ResultMapping**元素可以具有以下子元素：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-667">The **ResultMapping** element can have the following child elements:</span></span>

-   <span data-ttu-id="ad5fb-668">EntityTypeMapping（零个或多个）</span><span class="sxs-lookup"><span data-stu-id="ad5fb-668">EntityTypeMapping (zero or more)</span></span>
-   <span data-ttu-id="ad5fb-669">ComplexTypeMapping</span><span class="sxs-lookup"><span data-stu-id="ad5fb-669">ComplexTypeMapping</span></span>

<span data-ttu-id="ad5fb-670">没有适用于 **ResultMapping** 元素的特性。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-670">No attributes are applicable to the **ResultMapping** Element.</span></span>

### <a name="example"></a><span data-ttu-id="ad5fb-671">示例</span><span class="sxs-lookup"><span data-stu-id="ad5fb-671">Example</span></span>

<span data-ttu-id="ad5fb-672">请思考以下存储过程：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-672">Consider the following stored procedure:</span></span>
...
<span data-ttu-id="ad5fb-673">另请考虑使用以下概念模型实体类型：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-673">Also consider the following conceptual model entity type:</span></span>
...
<span data-ttu-id="ad5fb-674">若要创建返回以前实体类型的实例的函数导入，必须在 **ResultMapping** 元素中定义存储过程返回的列与实体类型返回的列之间的映射：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-674">In order to create a function import that returns instances of the previous entity type, the mapping between the columns returned by the stored procedure and the entity type must be defined in a **ResultMapping** element:</span></span>
...
## <a name="scalarproperty-element-msl"></a><span data-ttu-id="ad5fb-675">ScalarProperty 元素 (MSL)</span><span class="sxs-lookup"><span data-stu-id="ad5fb-675">ScalarProperty Element (MSL)</span></span>

<span data-ttu-id="ad5fb-676">映射规范语言 (MSL) 中的 **ScalarProperty** 元素将概念模型实体类型、复杂类型或关联的属性映射到基础数据库中的表列或存储过程参数。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-676">The **ScalarProperty** element in mapping specification language (MSL) maps a property on a conceptual model entity type, complex type, or association to a table column or stored procedure parameter in the underlying database.</span></span>

> [!NOTE]
> <span data-ttu-id="ad5fb-677">将修改函数映射到其中的存储过程必须在存储模型中声明。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-677">Stored procedures to which modification functions are mapped must be declared in the storage model.</span></span> <span data-ttu-id="ad5fb-678">有关详细信息，请参阅 Function 元素 (SSDL) 。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-678">For more information, see Function Element (SSDL).</span></span>

<span data-ttu-id="ad5fb-679">**ScalarProperty**元素可以是以下元素的子元素：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-679">The **ScalarProperty** element can be a child of the following elements:</span></span>

-   <span data-ttu-id="ad5fb-680">MappingFragment</span><span class="sxs-lookup"><span data-stu-id="ad5fb-680">MappingFragment</span></span>
-   <span data-ttu-id="ad5fb-681">InsertFunction</span><span class="sxs-lookup"><span data-stu-id="ad5fb-681">InsertFunction</span></span>
-   <span data-ttu-id="ad5fb-682">UpdateFunction</span><span class="sxs-lookup"><span data-stu-id="ad5fb-682">UpdateFunction</span></span>
-   <span data-ttu-id="ad5fb-683">DeleteFunction</span><span class="sxs-lookup"><span data-stu-id="ad5fb-683">DeleteFunction</span></span>
-   <span data-ttu-id="ad5fb-684">EndProperty</span><span class="sxs-lookup"><span data-stu-id="ad5fb-684">EndProperty</span></span>
-   <span data-ttu-id="ad5fb-685">ComplexProperty</span><span class="sxs-lookup"><span data-stu-id="ad5fb-685">ComplexProperty</span></span>
-   <span data-ttu-id="ad5fb-686">ResultMapping</span><span class="sxs-lookup"><span data-stu-id="ad5fb-686">ResultMapping</span></span>

<span data-ttu-id="ad5fb-687">作为 **MappingFragment**、 **ComplexProperty**或 **EndProperty** 元素的子元素， **ScalarProperty** 元素会将概念模型中的属性映射到数据库中的某一列。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-687">As a child of the **MappingFragment**, **ComplexProperty**, or **EndProperty** element, the **ScalarProperty** element maps a property in the conceptual model to a column in the database.</span></span> <span data-ttu-id="ad5fb-688">作为 **InsertFunction**、 **UpdateFunction**或 **DeleteFunction** 元素的子元素， **ScalarProperty** 元素会将概念模型中的属性映射到存储过程参数。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-688">As a child of the **InsertFunction**, **UpdateFunction**, or **DeleteFunction** element, the **ScalarProperty** element maps a property in the conceptual model to a stored procedure parameter.</span></span>

<span data-ttu-id="ad5fb-689">**ScalarProperty**元素不能具有任何子元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-689">The **ScalarProperty** element cannot have any child elements.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="ad5fb-690">适用的属性</span><span class="sxs-lookup"><span data-stu-id="ad5fb-690">Applicable Attributes</span></span>

<span data-ttu-id="ad5fb-691">应用于 **ScalarProperty** 元素的特性因元素的角色而异。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-691">The attributes that apply to the **ScalarProperty** element differ depending on the role of the element.</span></span>

<span data-ttu-id="ad5fb-692">下表介绍了在 **ScalarProperty** 元素用于将概念模型属性映射到数据库中的列时适用的特性：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-692">The following table describes the attributes that are applicable when the **ScalarProperty** element is used to map a conceptual model property to a column in the database:</span></span>

| <span data-ttu-id="ad5fb-693">属性名称</span><span class="sxs-lookup"><span data-stu-id="ad5fb-693">Attribute Name</span></span> | <span data-ttu-id="ad5fb-694">是否必需</span><span class="sxs-lookup"><span data-stu-id="ad5fb-694">Is Required</span></span> | <span data-ttu-id="ad5fb-695">值</span><span class="sxs-lookup"><span data-stu-id="ad5fb-695">Value</span></span>                                                           |
|:---------------|:------------|:----------------------------------------------------------------|
| <span data-ttu-id="ad5fb-696">**名称**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-696">**Name**</span></span>       | <span data-ttu-id="ad5fb-697">是</span><span class="sxs-lookup"><span data-stu-id="ad5fb-697">Yes</span></span>         | <span data-ttu-id="ad5fb-698">要映射的概念模型属性的名称。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-698">The name of the conceptual model property that is being mapped.</span></span> |
| <span data-ttu-id="ad5fb-699">**ColumnName**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-699">**ColumnName**</span></span> | <span data-ttu-id="ad5fb-700">是</span><span class="sxs-lookup"><span data-stu-id="ad5fb-700">Yes</span></span>         | <span data-ttu-id="ad5fb-701">要映射的表列的名称。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-701">The name of the table column that is being mapped.</span></span>              |

<span data-ttu-id="ad5fb-702">下表描述了当 **ScalarProperty** 元素用于将概念模型属性映射到存储过程参数时适用的特性：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-702">The following table describes the attributes that are applicable to the **ScalarProperty** element when it is used to map a conceptual model property to a stored procedure parameter:</span></span>

| <span data-ttu-id="ad5fb-703">属性名称</span><span class="sxs-lookup"><span data-stu-id="ad5fb-703">Attribute Name</span></span>    | <span data-ttu-id="ad5fb-704">是否必需</span><span class="sxs-lookup"><span data-stu-id="ad5fb-704">Is Required</span></span> | <span data-ttu-id="ad5fb-705">值</span><span class="sxs-lookup"><span data-stu-id="ad5fb-705">Value</span></span>                                                                                                                                           |
|:------------------|:------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="ad5fb-706">**名称**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-706">**Name**</span></span>          | <span data-ttu-id="ad5fb-707">是</span><span class="sxs-lookup"><span data-stu-id="ad5fb-707">Yes</span></span>         | <span data-ttu-id="ad5fb-708">要映射的概念模型属性的名称。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-708">The name of the conceptual model property that is being mapped.</span></span>                                                                                 |
| <span data-ttu-id="ad5fb-709">**ParameterName**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-709">**ParameterName**</span></span> | <span data-ttu-id="ad5fb-710">是</span><span class="sxs-lookup"><span data-stu-id="ad5fb-710">Yes</span></span>         | <span data-ttu-id="ad5fb-711">正在映射的参数的名称。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-711">The name of the parameter that is being mapped.</span></span>                                                                                                 |
| <span data-ttu-id="ad5fb-712">**版本**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-712">**Version**</span></span>       | <span data-ttu-id="ad5fb-713">否</span><span class="sxs-lookup"><span data-stu-id="ad5fb-713">No</span></span>          | <span data-ttu-id="ad5fb-714">**当前** 或 **原始** 值，具体取决于是否应将当前值或属性的原始值用于并发检查。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-714">**Current** or **Original** depending on whether the current value or the original value of the property should be used for concurrency checks.</span></span> |

### <a name="example"></a><span data-ttu-id="ad5fb-715">示例</span><span class="sxs-lookup"><span data-stu-id="ad5fb-715">Example</span></span>

<span data-ttu-id="ad5fb-716">下面的示例演示了两种方法中使用的 **ScalarProperty** 元素：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-716">The following example shows the **ScalarProperty** element used in two ways:</span></span>

-   <span data-ttu-id="ad5fb-717">将 **person** 实体类型的属性映射到 **person**表的列。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-717">To map the properties of the **Person** entity type to the columns of the **Person**table.</span></span>
-   <span data-ttu-id="ad5fb-718">将 **Person** 实体类型的属性映射到 **UpdatePerson** 存储过程的参数。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-718">To map the properties of the **Person** entity type to the parameters of the **UpdatePerson** stored procedure.</span></span> <span data-ttu-id="ad5fb-719">存储过程在存储模型中声明。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-719">The stored procedures are declared in the storage model.</span></span>
...
### <a name="example"></a><span data-ttu-id="ad5fb-720">示例</span><span class="sxs-lookup"><span data-stu-id="ad5fb-720">Example</span></span>

<span data-ttu-id="ad5fb-721">下一个示例显示了 **ScalarProperty** 元素，该元素用于将概念模型关联的插入和删除函数映射到数据库中的存储过程。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-721">The next example shows the **ScalarProperty** element used to map the insert and delete functions of a conceptual model association to stored procedures in the database.</span></span> <span data-ttu-id="ad5fb-722">存储过程在存储模型中声明。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-722">The stored procedures are declared in the storage model.</span></span>
...
## <a name="updatefunction-element-msl"></a><span data-ttu-id="ad5fb-723">UpdateFunction 元素 (MSL)</span><span class="sxs-lookup"><span data-stu-id="ad5fb-723">UpdateFunction Element (MSL)</span></span>

<span data-ttu-id="ad5fb-724">映射规范语言 (MSL) 中的 **UpdateFunction** 元素将概念模型中的实体类型的更新函数映射到基础数据库中的存储过程。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-724">The **UpdateFunction** element in mapping specification language (MSL) maps the update function of an entity type in the conceptual model to a stored procedure in the underlying database.</span></span> <span data-ttu-id="ad5fb-725">将修改函数映射到其中的存储过程必须在存储模型中声明。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-725">Stored procedures to which modification functions are mapped must be declared in the storage model.</span></span> <span data-ttu-id="ad5fb-726">有关详细信息，请参阅 Function 元素 (SSDL) 。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-726">For more information, see Function Element (SSDL).</span></span>

> [!NOTE]
>  <span data-ttu-id="ad5fb-727">如果没有将实体类型的所有三个插入、更新或删除操作映射到存储过程，则在运行时执行并引发 UpdateException 时，未映射的操作将失败。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-727">If you do not map all three of the insert, update, or delete operations of a entity type to stored procedures, the unmapped operations will fail if executed at runtime and an UpdateException is thrown.</span></span>

<span data-ttu-id="ad5fb-728">**UpdateFunction**元素可以是 ModificationFunctionMapping 元素的子元素并应用于 EntityTypeMapping 元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-728">The **UpdateFunction** element can be a child of the ModificationFunctionMapping element and applied to the EntityTypeMapping element.</span></span>

<span data-ttu-id="ad5fb-729">**UpdateFunction**元素可以具有以下子元素：</span><span class="sxs-lookup"><span data-stu-id="ad5fb-729">The **UpdateFunction** element can have the following child elements:</span></span>

-   <span data-ttu-id="ad5fb-730">AssociationEnd（零个或多个）</span><span class="sxs-lookup"><span data-stu-id="ad5fb-730">AssociationEnd (zero or more)</span></span>
-   <span data-ttu-id="ad5fb-731">ComplexProperty（零个或多个）</span><span class="sxs-lookup"><span data-stu-id="ad5fb-731">ComplexProperty (zero or more)</span></span>
-   <span data-ttu-id="ad5fb-732">ResultBinding（零个或一个）</span><span class="sxs-lookup"><span data-stu-id="ad5fb-732">ResultBinding (zero or one)</span></span>
-   <span data-ttu-id="ad5fb-733">ScarlarProperty（零个或多个）</span><span class="sxs-lookup"><span data-stu-id="ad5fb-733">ScarlarProperty (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="ad5fb-734">适用的属性</span><span class="sxs-lookup"><span data-stu-id="ad5fb-734">Applicable Attributes</span></span>

<span data-ttu-id="ad5fb-735">下表介绍可应用于 **UpdateFunction** 元素的特性。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-735">The following table describes the attributes that can be applied to the **UpdateFunction** element.</span></span>

| <span data-ttu-id="ad5fb-736">属性名称</span><span class="sxs-lookup"><span data-stu-id="ad5fb-736">Attribute Name</span></span>            | <span data-ttu-id="ad5fb-737">是否必需</span><span class="sxs-lookup"><span data-stu-id="ad5fb-737">Is Required</span></span> | <span data-ttu-id="ad5fb-738">值</span><span class="sxs-lookup"><span data-stu-id="ad5fb-738">Value</span></span>                                                                                                                                                    |
|:--------------------------|:------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="ad5fb-739">**FunctionName**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-739">**FunctionName**</span></span>          | <span data-ttu-id="ad5fb-740">是</span><span class="sxs-lookup"><span data-stu-id="ad5fb-740">Yes</span></span>         | <span data-ttu-id="ad5fb-741">更新函数要映射到的存储过程的命名空间限定名称。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-741">The namespace-qualified name of the stored procedure to which the update function is mapped.</span></span> <span data-ttu-id="ad5fb-742">存储过程必须在存储模型中声明。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-742">The stored procedure must be declared in the storage model.</span></span> |
| <span data-ttu-id="ad5fb-743">**RowsAffectedParameter**</span><span class="sxs-lookup"><span data-stu-id="ad5fb-743">**RowsAffectedParameter**</span></span> | <span data-ttu-id="ad5fb-744">否</span><span class="sxs-lookup"><span data-stu-id="ad5fb-744">No</span></span>          | <span data-ttu-id="ad5fb-745">返回受影响行数的输出参数的名称。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-745">The name of the output parameter that returns the number of rows affected.</span></span>                                                                               |

### <a name="example"></a><span data-ttu-id="ad5fb-746">示例</span><span class="sxs-lookup"><span data-stu-id="ad5fb-746">Example</span></span>

<span data-ttu-id="ad5fb-747">下面的示例基于 School 模型，并显示用于将**Person**实体类型的更新函数映射到**UpdatePerson**存储过程的**UpdateFunction**元素。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-747">The following example is based on the School model and shows the **UpdateFunction** element used to map update function of the **Person** entity type to the **UpdatePerson** stored procedure.</span></span> <span data-ttu-id="ad5fb-748">**UpdatePerson**存储过程在存储模型中声明。</span><span class="sxs-lookup"><span data-stu-id="ad5fb-748">The **UpdatePerson** stored procedure is declared in the storage model.</span></span>
