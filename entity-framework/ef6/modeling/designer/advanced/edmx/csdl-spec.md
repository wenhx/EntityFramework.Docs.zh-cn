...
|:-----------------|:------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 类型         | 是         | 关联一端的实体类型的名称。                                                                                                                                                                                                                                                                                                                                                         |
| **Role**         | 否          | 关联端的名称。 如果不提供名称，将使用关联端的实体类型的名称。                                                                                                                                                                                                                                                                                           |
...
| **Role**       | 否          | 关联集端的名称。 如果未使用 **Role** 属性，则关联集端的名称将为实体集的名称。                                                                   |
...
| **摘要**                                                                                                                                    | 否          | **True** 或 **False**，具体取决于实体类型是否为抽象类型。                 |
