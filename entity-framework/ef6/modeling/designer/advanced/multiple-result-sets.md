...
## <a name="accessing-multiple-result-sets-with-code"></a><span data-ttu-id="3c209-112">用代码访问多个结果集</span><span class="sxs-lookup"><span data-stu-id="3c209-112">Accessing Multiple Result Sets with Code</span></span>
