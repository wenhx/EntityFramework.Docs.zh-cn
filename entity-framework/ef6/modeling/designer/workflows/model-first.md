...
现在我们有了几个实体，接下来可以在它们之间添加关联 (或关系) 。

-   右键单击设计图面，然后选择 "**添加新 &gt; 关联 ...** "
-   使关系点的一端成为使用**1**的重**数的****博客**，另一个终结点**的重数，** 
     *这意味着，博客包含多篇文章，张贴内容属于一个博客*
...
-   选择**适用于 C \# 的 EF DbContext 生成器**，输入**BloggingModel**作为名称，然后单击 "**添加**"
