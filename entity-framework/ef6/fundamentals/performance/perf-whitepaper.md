...
| `  var c1 = q1.First();`                                                                             | LINQ 查询执行      | - 元数据加载：高但缓存 <br/> -查看生成：但缓存可能是非常高 <br/> - 参数评估：中等 <br/> -查询转换：中等 <br/> - 具体化器生成：但缓存中 <br/> - 执行数据库查询：可能会很高 <br/> + Connection.Open <br/> + Command.ExecuteReader <br/> + DataReader.Read <br/> 对象具体化：中等 <br/> - 标识查找：中等 | - 元数据加载：高但缓存 <br/> -查看生成：但缓存可能是非常高 <br/> - 参数评估：低 <br/> -查询转换：但缓存中 <br/> - 具体化器生成：但缓存中 <br/> - 执行数据库查询：可能会很高 （更好的查询在某些情况下） <br/> + Connection.Open <br/> + Command.ExecuteReader <br/> + DataReader.Read <br/> 对象具体化：中等 <br/> - 标识查找：中等 | - 元数据加载：高但缓存 <br/> -查看生成：但缓存中 <br/> - 参数评估：低 <br/> -查询转换：但缓存中 <br/> - 具体化器生成：但缓存中 <br/> - 执行数据库查询：可能会很高 （更好的查询在某些情况下） <br/> + Connection.Open <br/> + Command.ExecuteReader <br/> + DataReader.Read <br/> 对象具体化：中等 （比 EF5 快） <br/> - 标识查找：中等 |
...
| `using(var db = new MyContext())` <br/> `{`                                                          | 上下文创建          | 中等                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | 中等                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | 低                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `  var q1 = ` <br/> `    from c in db.Customers` <br/> `    where c.Id == id1` <br/> `    select c;` | 查询表达式创建 | 低                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | 低                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | 低                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `  var c1 = q1.First();`                                                                             | LINQ 查询执行      | - 元数据~~加载~~查找：~~高，但缓存~~低 <br/> -查看~~生成~~查找：~~可能会非常高但缓存~~低 <br/> - 参数评估：中等 <br/> -查询~~翻译~~查找：中等 <br/> -具体化~~生成~~查找：~~中型，但缓存~~低 <br/> - 执行数据库查询：可能会很高 <br/> + Connection.Open <br/> + Command.ExecuteReader <br/> + DataReader.Read <br/> 对象具体化：中等 <br/> - 标识查找：中等 | - 元数据~~加载~~查找：~~高，但缓存~~低 <br/> -查看~~生成~~查找：~~可能会非常高但缓存~~低 <br/> - 参数评估：低 <br/> -查询~~翻译~~查找：~~中型，但缓存~~低 <br/> -具体化~~生成~~查找：~~中型，但缓存~~低 <br/> - 执行数据库查询：可能会很高 （更好的查询在某些情况下） <br/> + Connection.Open <br/> + Command.ExecuteReader <br/> + DataReader.Read <br/> 对象具体化：中等 <br/> - 标识查找：中等 | - 元数据~~加载~~查找：~~高，但缓存~~低 <br/> -查看~~生成~~查找：~~中型，但缓存~~低 <br/> - 参数评估：低 <br/> -查询~~翻译~~查找：~~中型，但缓存~~低 <br/> -具体化~~生成~~查找：~~中型，但缓存~~低 <br/> - 执行数据库查询：可能会很高 （更好的查询在某些情况下） <br/> + Connection.Open <br/> + Command.ExecuteReader <br/> + DataReader.Read <br/> 对象具体化：中等 （比 EF5 快） <br/> - 标识查找：中等 |
| `}`                                                                                                  | Connection.Close          | 低                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | 低                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | 低                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
-   查询计划缓存将共享所有查询类型：实体 SQL、 LINQ to Entities 和 CompiledQuery 对象。
...
| 配置                              | 使用时间的细目                                                                                                                                               |
|:-------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Visual Studio 2010 中，实体框架 4     | SSDL 生成：2 小时 27 分钟 <br/> 生成的映射：1 秒 <br/> CSDL 生成：1 秒 <br/> ObjectLayer 生成：1 秒 <br/> 视图生成：2 小时 14 分钟 |
| Visual Studio 2010 SP1 中，实体框架 4 | SSDL 生成：1 秒 <br/> 生成的映射：1 秒 <br/> CSDL 生成：1 秒 <br/> ObjectLayer 生成：1 秒 <br/> 视图生成：1 小时 53 分钟   |
| Visual Studio 2013 中，实体框架 5     | SSDL 生成：1 秒 <br/> 生成的映射：1 秒 <br/> CSDL 生成：1 秒 <br/> ObjectLayer 生成：1 秒 <br/> 视图生成：65 分钟    |
| Visual Studio 2013 中，实体框架 6     | SSDL 生成：1 秒 <br/> 生成的映射：1 秒 <br/> CSDL 生成：1 秒 <br/> ObjectLayer 生成：1 秒 <br/> 视图生成：28 秒。   |
